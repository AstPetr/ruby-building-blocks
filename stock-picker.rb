...
# Geriausia diena pirkti
	...
	return pirk_diena, pirk, parduok_diena, parduok
end
...
# tai tikrai ne pats geriausias metodas
pirk_diena, pirk, parduok_diena, parduok = stock_picker(kainos)
